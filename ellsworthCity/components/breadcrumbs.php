<!-- BREADCRUMBS : begin -->
<?php /*zig mods:   for notices & documents, dont put post title as 'category' 
*        12July add link for employment for jobs 
*/ ?>
...
if ( get_option( 'page_for_posts' ) ) : ?>
	<?php $blog_page_html = '<li class="page-for-posts"><a  href="' . esc_url( get_permalink( get_option( 'page_for_posts' ) ) ) . '">' . get_the_title( get_option( 'page_for_posts' ) ) . '</a></li>';	?>
<?php elseif ( lsvr_get_field( 'articles_base_page' ) ) : ?>
	<?php $blog_page_html = '<li class="articles_base_page"><a  href="' . esc_url( home_url() ) . '">' . get_the_title( lsvr_get_field( 'articles_base_page' ) ) . '</a></li>';	?>
<?php else : ?>
	<?php $blog_page_html = '<li class="else"><a href="' . esc_url( home_url() ) . '">' . __( 'Blog', 'lsvrtheme' ) . '</a></li>';	?>
<?php endif; ?>
...
<?php elseif ( is_tag() ) : ?>
	...
	<?php echo $blog_page_html; ?>
	<li class="tag"><?php echo single_tag_title( '', false ); ?></li>
...
<?php elseif ( is_singular( 'post' ) ) : ?>
	...
	<?php echo $blog_page_html; ?>
	<li class="singular_post"><?php echo get_the_title(); ?></li>
...
elseif ( is_post_type_archive( 'lsvrnotice' ) ) : ?>
	...
	<li class="lsvrnotice" ><?php echo /* get_the_title( lsvr_get_current_page_id() )*/ 'All Notices'; ?></li>

<?php elseif ( is_singular( 'lsvrnotice' ) ) : ?>

	<li class="is_singular_lsvrnotice"><a href="<?php echo esc_url( get_post_type_archive_link( 'lsvrnotice' ) ); ?>"><?php echo "Notice"; /* zig get_the_title( lsvr_get_current_page_id() ); */ ?></a></li>
	<li><?php echo get_the_title(); ?></li>
...
<?php elseif ( is_tax( 'lsvrnoticecat' ) ) : ?>
	...
	<li class="tax_lsvrnoticecat"><a href="<?php echo esc_url( get_post_type_archive_link( 'lsvrnotice' ) ); ?>"><?php echo "Notices"; /* zig get_the_title( lsvr_get_current_page_id() ); */ ?></a></li>
...
elseif ( is_post_type_archive( 'lsvrdocument' ) ) : ?>
	...
	<?php if ( $is_archive ) : ?>
		<li class="doc_archive" ><a href="<?php echo esc_url( get_post_type_archive_link( 'lsvrdocument' ) ); ?>"><?php echo get_the_title( lsvr_get_current_page_id() ); ?></a></li>
		<li><?php _e( 'Archive', 'lsvrtheme' ); ?></li>
	<?php else : ?>
		<li class="post_type_archive_docs"><?php echo /* get_the_title( lsvr_get_current_page_id() ); */ "All Documents"; ?></li>
	<?php endif; ?>

<?php elseif ( is_singular( 'lsvrdocument' ) ) : ?>

	<li><a href="<?php echo esc_url( get_post_type_archive_link( 'lsvrdocument' ) ); ?>"><?php echo "Document"; /* get_the_title( lsvr_get_current_page_id() ); */ ?></a></li>
	<li><?php echo get_the_title(); ?></li>
...
<?php elseif ( is_tax( 'lsvrdocumentcat' ) ) : ?>
	...
	<?php global $wp_query; ?>
	<?php $current_term = $wp_query->queried_object; ?>
	<li class="lsvrdoccat-first"><a href="<?php echo esc_url( get_post_type_archive_link( 'lsvrdocument' ) ); ?>"><?php /* echo zig xout get_the_title( lsvr_get_current_page_id() ); */ echo 'Documents' ?></a></li>
	<?php if ( $is_archive ) : ?>
		<li class="lsvrdocumentcat_archive"><a href="<?php echo esc_url( add_query_arg( array( 'archive' => 'true' ), get_post_type_archive_link( 'lsvrdocument' ) ) ); ?>"><?php _e( 'Archive', 'lsvrtheme' ); ?></a></li>
	<?php endif; ?>
	...
	<?php if ( is_array( $term_parents_arr ) ) : ?>
		...
		<?php endforeach; ?>
	<?php endif; ?>
	<li class="lsvrdocumentcat_archive-name"><?php echo $current_term->name; ?></li>
...
elseif ( is_singular('job_listing') ) : ?>
	...
	<li><a href="<?php echo get_permalink(get_option( 'job_manager_jobs_page_id' )); ?>"><?php echo get_the_title(get_option( 'job_manager_jobs_page_id' )); ?></li></a>
	<li><?php echo get_the_title(); ?></li>
